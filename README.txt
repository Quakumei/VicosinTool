...
-- 1) Go here and press allow --> https://oauth.vk.com/authorize?client_id=7218375&scope=photos,audio,video,docs,notes,pages,status,questions,wall,groups,email,notifications,stats,offline,docs,messages,pages,stats,notifications&response_type=token
